cask "beacon" do
  ...
  on_arm do
    ...
    sha256 "99fdf7f376240fad8e5291ea55e5b163223fe62f2b26e9c27052ccadbe2607e0"
  end

  on_intel do
    url "https://github.com/konradmichalik/beacon/releases/download/#{version.after_comma}/Beacon_#{version.before_comma}_x64.dmg"
    sha256 "6c293720fd250f838e076212053ae797615979ad2c4d88d1b5e45deba3e9e31a"
  end
